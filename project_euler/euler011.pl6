my $nums = "08 02 22 97 38 15 00 40 00 75 04 05 07 78 52 12 50 77 91 08
...
my $row = $nums.split("\n");
my @grid = $x.split(" ").Int for $x of $rows;
my $max_prod, $product = 0;
...
say "The maximum product is $max_prod";
